...
public class DBManager {
    ...
    public DBManager(Context context, Class<?> clazz) {
        MySQLiteHelper mHelper = new MySQLiteHelper(context, clazz);
        db = mHelper.getWritableDatabase();
        this.mContext = context;
    }

    public DBManager(Context context, List<Class> classList) {
        MySQLiteHelper mHelper = new MySQLiteHelper(context, classList);
        db = mHelper.getWritableDatabase();
        this.mContext = context;
    }
     ...
     */
    public boolean deleteDataBase(String db_name) {
    ...
    public void deleteById(Class<?> clazz, long id) {
        db.delete(DBUtil.getTableName(clazz), "id=" + id, null);
    }
    ...
    public void deleteTable(Class<?> clazz) {
        db.execSQL("DROP TABLE IF EXISTS" + DBUtil.getTableName(clazz));
    }
